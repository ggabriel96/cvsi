 ...
 * ./endpoints-framework-tools-2.0.5/bin/endpoints-framework-tools get-openapi-doc --hostname=cvsi-backend.appspot.com --war=./backend/build/exploded-app io.github.ggabriel96.cvsi.backend.MyEndpoint
 * Then publish:
