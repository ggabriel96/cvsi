...
public class SQLiteHelper extends SQLiteOpenHelper {
  ...
  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
    ...
    switch (newVersion) {
      case 2:
        db.execSQL("alter table " + PictureContract.PictureEntry.TABLE_NAME + " add column " + PictureContract.PictureEntry.COLUMN_AZIMUTH + " real;");
        db.execSQL("alter table " + PictureContract.PictureEntry.TABLE_NAME + " add column " + PictureContract.PictureEntry.COLUMN_PITCH + " real;");
        db.execSQL("alter table " + PictureContract.PictureEntry.TABLE_NAME + " add column " + PictureContract.PictureEntry.COLUMN_ROLL + " real;");
    }
  }
}
